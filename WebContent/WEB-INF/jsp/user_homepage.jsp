				...
				<div id="content">
					<div class="container">
						<div id="main">
							<div class="row">
								<div class="span12">
									<h2 class="page-header">我的收藏</h2>

									<div class="properties-grid">
										<div class="row">
											<c:if test="${empty likelist.datas }">
												<p style="text-align:center ">目前您还没有收藏的商品！</p>
											</c:if>
											<c:forEach items="${likelist.datas}" var="um">
												<div class="property span3">
													<div class="image">
														<div class="content">
															<a href="detail?id=${um.goods.id}"></a>
															<img src="resources/photo/${um.goods.img }" alt="">
														</div>
														<!-- /.content -->

														<div class="price">￥${um.goods.price}</div>
														<!-- /.price -->
														<div class="reduced">${um.goods.discount}</div>
														<!-- /.reduced -->
													</div>
													<!-- /.image -->
													...
													<h2 style="overflow:hidden;text-overflow:ellipsis;">
														<a style= "white-space: nowrap;width=100%;" href="detail?id=${um.goods.id }">${um.goods.name }</a>
													</h2>
													</div>
													<!-- /.title -->
													...
													<div class="area">
														...
														<!-- /.key -->
														<span class="value">${um.goods.type }</span>
														<!-- /.value -->
													</div>
													<!-- /.area -->
													<div class="bedrooms">
														<a href="delete_likelistGoods?id=${um.id}">取消收藏</a>
													</div>
												</div>
												<!-- /.property -->
											</c:forEach>
									...
									<div class="pagination pagination-centered">
										<ul>
											<pg:pager maxPageItems="9" items="${likelist.totalRecord}" export="curPage = pageNumber" url="list">

												<pg:param name="name" value="${search_name}" />
												<pg:last>
													<p>共${likelist.totalRecord}条记录，共${pageNumber}页，当前第${curPage}页</p>
												</pg:last>
