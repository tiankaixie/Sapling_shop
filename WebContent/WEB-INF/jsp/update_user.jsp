									...
									<div class="row">
										<div class="span4">
											<ul class="tabs nav nav-tabs">
												<li class="active"><a href="#">修改用户</a></li>
											</ul>
											<!-- /.nav -->
												...
												<div class="tab-pane active" id="register">
													<sf:form method="post" modelAttribute="user"
														...
														<div class="control-group">
															...
															<div class="controls">
																<sf:input path="username" value="${old_user.username }" />
														...
														<div class="control-group">
															<label class="control-label" for="inputRegisterSurname">密码
																<span class="form-required"
																title="This field is required.">*</span>
															</label>

															<div class="controls">
																<sf:input path="password" value="${old_user.password }" />
														...
														<div class="control-group">
															...
															<div class="controls">
																<sf:input path="email" value="${old_user.email }" />
