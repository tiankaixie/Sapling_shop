						...
						<div id="main">
							...
							<form method="get" action="addStock">
								<table class="table table-striped table-bordered table-hover">
									<tr>
										...
										<tr>
											<td><img style="width: 100px; height: 100px"
												src="resources/photo/${goodsToUpshelf.img}" alt=""></td>
											<td>${goodsToUpshelf.name}</td>
											<td>${goodsToUpshelf.type }</td>
											<td>${goodsToUpshelf.varieties}</td>
											<td>${goodsToUpshelf.price}</td>
											<td>
									...
									<tr>
										<td colspan="9">
										<input type="hidden" name="goods_id" value="${goodsToUpshelf.id}"/>
											 <input
											style="float: right" type="submit" value="确定上架"
