									...
									<div class="pagination pagination-centered">
										<ul>
											<pg:pager maxPageItems="9" items="${the_goods.totalRecord}"
												export="curPage = pageNumber" url="quickSearch">
											
												
														<pg:param name="category" value="${category_Info}" />
														<pg:param name="isEverGreen" value="${isEverGreen_Info}" />
														<pg:param name="type" value="${type_Info}" />
														<pg:param name="lowPrice" value="${lowPrice_Info}" />
														<pg:param name="highPrice" value="${highPrice_Info}" />
