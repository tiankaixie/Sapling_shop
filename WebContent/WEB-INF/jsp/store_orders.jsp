							...
							<div class="navigation clearfix-normal">
								<ul class="nav">
									...
									<c:if test="${loginUser.type=='1'}">
										<li><a href="store">我的店铺</a></li>
										<li><a href="#">修改店铺信息</a></li>
										<li><a class="active" href="store_orders">店铺订单</a></li>
									</c:if>
								</ul>
								<!-- /.nav -->
							</div>
				...
				<div id="content">
					<div class="container">
						...
						<div id="main">
							<div class="row">
								<div class="span9">
									<h1 class="page-header">店铺订单</h1>

									<div class="properties-rows">
										<div class="row">
											<c:if test="${empty store_orders.datas }">
												<p style="text-align: center">目前您还没有订单！</p>
											</c:if>
											<c:forEach items="${store_orders.datas}" var="um">
													...
													<div class="row">
														...
														<div class="body span6">
															...
															<div style="float:right" class="area">
																<a href="delete_orders?orders_id=${um.id }">删除该订单</a>
															</div>
														</div>
														<!-- /.body -->
													</div>
									...
									<div class="pagination pagination-centered">
										<ul>
											<pg:pager maxPageItems="9"
												items="${store_orders.totalRecord}"
												export="curPage = pageNumber" url="store_orders">

												<pg:last>
													<p>共${store_orders.totalRecord}条记录，共${pageNumber}页，当前第${curPage}页</p>
												</pg:last>
