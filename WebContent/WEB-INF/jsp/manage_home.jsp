						...
						<div class="navigation-wrapper">
							<div class="navigation clearfix-normal">
								...
								<ul class="nav">
									...
									<li><a class="active" href="manage_home">管理首页</a></li>
								</ul>
								<!-- /.nav -->
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<c:forEach items="${roll}" var="um">
									<tr>
										...
										<td>${um.goods.discount }</td>
										<td><a href="delete_recommend?id=${um.id }">删除</a></td>
									</tr>
								</c:forEach>
								<tr>
									<th colspan="8">网站推荐(仅四个)</th>
								</tr>
								<tr>
									<th>ID</th>
									<th>商品ID</th>
