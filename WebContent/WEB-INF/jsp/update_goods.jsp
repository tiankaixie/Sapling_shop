										...
										<div class="span8">
											...
											<div class="tab-content">
												...
												<div class="tab-pane active" id="register">
													<sf:form method="post" modelAttribute="goods" action="update_goods"  enctype="multipart/form-data">
														...
														<div class="control-group">
															<label class="control-label" for="inputRegisterRetype"> 种类 （造型苗/景观苗/普通苗）<span class="form-required" title="This field is required.">*</span>
															</label>
														...
														<div class="control-group">
															...
															<sf:hidden path="id" value="${update_goods_id }"/>
															<sf:hidden path="store_id" value="${my_store.id }" />
														<!-- /.control-group -->
														<div class="form-actions">
															<input type="submit" value="更新商品" class="btn btn-primary arrow-right">
														</div>
														<!-- /.form-actions -->
													</sf:form>
												</div>
