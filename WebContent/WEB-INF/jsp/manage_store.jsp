						...
						<div class="navigation-wrapper">
							<div class="navigation clearfix-normal">
								...
								<ul class="nav">
									...
									<li><a class="active" href="#">管理店铺</a></li>
					...
					<div class="container">
						<div id="main">
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<c:forEach items="${allStore.datas}" var="um">
									<tr>
										<td>${um.id}</td>
										<td>${um.name}</td>
										<td>${um.email}</td>
										...
										<td>${um.postcode}</td>
										<td>${um.address}</td>
										<td><a href="update_store?id=${um.id }">修改店铺</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="delete_store?id=${um.id }">删除店铺</a></td>
									</tr>
								</c:forEach>
							...
							<div class="pagination pagination-centered">
										<ul>
											<pg:pager maxPageItems="9" items="${allStore.totalRecord}" export="curPage = pageNumber" url="manage_store">

								
												<pg:last>
													<p>共${allStore.totalRecord}条记录，共${pageNumber}页，当前第${curPage}页</p>
												</pg:last>
