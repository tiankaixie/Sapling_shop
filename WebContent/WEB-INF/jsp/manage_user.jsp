						...
						<div class="navigation-wrapper">
							<div class="navigation clearfix-normal">
								...
								<ul class="nav">
									...
									<li><a class="active" href="#">管理账户</a></li>
					...
					<div class="container">
						<div id="main">
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<c:forEach items="${users.datas}" var="um">
									<tr>
										...
										<td>${um.email}</td>
										<td>${um.type}</td>
										<td><a href="update_user?id=${um.id }">修改账户</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="delete_user?id=${um.id }">删除账户</a></td>
									</tr>
								</c:forEach>
							...
							<div class="pagination pagination-centered">
										<ul>
											<pg:pager maxPageItems="9" items="${users.totalRecord}" export="curPage = pageNumber" url="manage_user">

								
												<pg:last>
													<p>共${users.totalRecord}条记录，共${pageNumber}页，当前第${curPage}页</p>
												</pg:last>
